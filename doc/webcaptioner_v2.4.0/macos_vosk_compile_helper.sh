...
export BREW_BOOST_VERSION=1.92.0
export BREW_ONNX_VERSION=1.29.0_2
...
if [[ ! -e /opt/homebrew/Cellar/boost/${BREW_BOOST_VERSION}/ ]] ; then 
    ...
    echo "Candidates: "
    ls -1d /opt/homebrew/Cellar/boost/*
    exit 1
fi
...
if [[ ! -e /opt/homebrew/Cellar/onnxruntime/${BREW_ONNX_VERSION}/ ]] ; then 
    ...
    echo "Candidates: "
    ls -1d /opt/homebrew/Cellar/onnxruntime/*
    exit 1
fi
...
whisper_out/ResamplerWebRTC_8_16.cpp whisper_out/ResamplerLibResample_8_16.cpp \
