...
To specify the nvidia driver and version, go to https://packages.ubuntu.com and find a driver version that matches the output of "nvidia-smi" in WSL best. It is unlikely to match 100%
