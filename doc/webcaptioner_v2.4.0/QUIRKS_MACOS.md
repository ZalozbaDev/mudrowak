...
```bash
echo "cd docker_vosk && DYLD_LIBRARY_PATH=./whisper_out/ VOSK_SAMPLE_RATE=48000 VOSK_WHISPER_NO_FALLBACK=true VOSK_SHOW_WORDS=True VOSK_WHISPER_DISABLE_TIMESTAMPS=true VOSK_LOG_AUDIO=true VOSK_VAD_ALGO=Silero VOSK_PROB_THRESHOLD_REJECT=0.80 VOSK_LOGPROB_THRESHOLD_REJECT=-1.0 VOSK_REJECT_RESPONSE=njezrozumliwe VOSK_PROB_THRESHOLD_DISCARD=0.70 VOSK_LOGPROB_THRESHOLD_DISCARD=-1.5 VOSK_HUNSPELL_AFF_FILE=~/soblex/hsb_DE_soblex.aff VOSK_HUNSPELL_DIC_FILE=~/soblex/hsb_DE_soblex.dic VOSK_REPLACEMENT_FILE=~/mudrowak/doc/models/replacement_lists/Korla_whisper_large_v3_turbo_hsb-0.txt ./whisper_out/vosk_whisper_server 0.0.0.0 2700 1 ~/whisper_models/Korla/whisper_large_v3_turbo_hsb-v1/coreml/ggml-large-v3-turbo.bin" > ~/Desktop/spóznawanje.command
