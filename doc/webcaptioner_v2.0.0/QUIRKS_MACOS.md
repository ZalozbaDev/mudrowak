...
```bash
echo "cd docker_vosk && DYLD_LIBRARY_PATH=./whisper_out/ VOSK_SAMPLE_RATE=48000 VOSK_WHISPER_NO_FALLBACK=true VOSK_SHOW_WORDS=True VOSK_HUNSPELL_AFF_FILE=~/soblex/hsb_DE_soblex.aff VOSK_HUNSPELL_DIC_FILE=~/soblex/hsb_DE_soblex.dic VOSK_REPLACEMENT_FILE=~/mudrowak/doc/models/replacement_lists/Korla_whisper_large_v3_turbo_hsb-0.txt ./whisper_out/vosk_whisper_server 0.0.0.0 2700 1 ~/whisper_models/Korla/whisper_large_v3_turbo_hsb-0/coreml/ggml-large-v3-turbo.bin" > ~/Desktop/spóznawanje.command
